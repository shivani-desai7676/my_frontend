    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "Arial" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "20px", display: "flex", gap: "10px" }}>
          ...
          <button style={topBtn} onClick={goBackLogin}>
            ← Back to Login
          </button>

          <button style={topBtn} onClick={goHome}>
            🏠 Home
          </button>
        ...
        {section === "userlinks" && <AdminUserLinks />}
      ...
      >
        ...
        <button
          style={{ ...menuBtn, background: "#ef4444" }}
          onClick={logout}
        >
          Logout
        </button>
